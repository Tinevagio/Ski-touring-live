...
df["ski_score_physical_raw"] = (
    -0.40 * df["temp_max_7d_avg"]      # douceur prolongée
    + 0.35 * df["snowfall_7d_sum"]      # recharge neige
    - 0.25 * df["wind_max_7d"]          # vent destructeur
    + 0.30 * df["freeze_thaw_cycles_7d"]# regel
    - 0.15 * df["temp_amp_7d_avg"]      # alternance pénible
)
